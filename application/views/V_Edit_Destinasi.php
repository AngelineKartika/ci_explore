                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Edit Data Destinasi</strong>

                                  </div>
                                      <?php foreach ($destinasi as $a)?>
                                  <form action="<?php echo base_url().'Destinasi/UpdateData';?>" method="post">
                                  <div class="card-body card-block">
                                      <div class="form-group">
                                          <label for="company" class=" form-control-label">ID Destinasi</label>
                                          <input type="text" id="company" class="form-control" name="id" value="<?=$a->id_destinasi?>" readonly>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Nama Destinasi</label>
                                          <input type="text" id="vat" class="form-control" name="nama" value="<?=$a->nama_destinasi?>">
                                      </div>
