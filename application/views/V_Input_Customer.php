                        ...
                        <div class="row">
                            <div class="col-lg-9">
                              <div class="card">
                                  ...
                                  <form action="<?php echo base_url().'Pengguna/insertData';?>" method="post">
                                  <div class="card-body card-block">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" id="vat" class="form-control" name="pass">
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Email</label>
                                          <input type="text" id="vat" class="form-control" name="email">
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Alamat</label>
                                          <input type="text" id="vat" class="form-control" name="alamat">
                                      </div>
                                      <div class="form-group">
