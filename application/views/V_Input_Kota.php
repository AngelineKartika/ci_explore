                        ...
                        <div class="row">
                            <div class="col-lg-9">
                              <div class="card">
                                  ...
                                  <form action="<?php echo base_url().'Kota/insertData';?>" method="post">
                                  <div class="card-body card-block">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label">ID</label>
                                        <?php
                                        $queryp=mysqli_query($koneksi,"SELECT *FROM kota");
                                        $baris=mysqli_num_rows($queryp);
                                        $barisbaru=$baris+1;
                                        ?>
                                        <input type="text" id="company" class="form-control" name="id" value="<?php echo "K-".$barisbaru?>" readonly>
                                    </div>
                                      <div class="form-group">
