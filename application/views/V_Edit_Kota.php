                        ...
                        <div class="row">
                            <div class="col-lg-9">
                              <div class="card">
                                  ...
                                  <?php foreach ($kota as $listKotaEdit)?>

                                  <form action="<?php echo base_url().'Kota/UpdateData';?>" method="post">
                                  <div class="card-body card-block">
                                      <div class="form-group">
                                          <label for="company" class=" form-control-label">ID Kota</label>
                                          <input type="text" id="company" class="form-control" name="id" value="<?=$listKotaEdit->id_kota?>" readonly>
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Nama Kota</label>
                                          <input type="text" id="vat" class="form-control" name="nama" value="<?=$listKotaEdit->nama_kota?>">
                                      </div>
