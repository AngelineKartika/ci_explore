                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php
                                        foreach($order_cust as $a){?>
                                        <tbody>
                                            <tr>
                                              <td><?php echo $a -> id_order?></td>
                                              <td><?php echo $a -> nama_tour?></td>
                                              <td><?php echo $a -> nama_pengguna?></td>
                                              <td><?php echo $a -> harga_promo?></td>
                                              <td><?php echo $a -> id_tg?></td>


                                              <td>

                                                <a href="<?php echo base_url().'Order/hapusData/'.$a->id_order;?>"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Done"><i class="fas fa-check"></i></button></a>
