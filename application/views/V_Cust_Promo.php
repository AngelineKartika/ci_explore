                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Tambah Promo Customer</strong>

                                  </div>
                                    <?php foreach ($pengguna as $a)?>
                                  <form action="<?php echo base_url().'Pengguna/updatePromo';?>" method="post">
                                  <div class="card-body card-block">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label">ID Customer</label>
