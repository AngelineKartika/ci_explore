                                        ...
                                        <tbody>
                                            <tr>
                                              ...
                                              <td>
                                                ...
                                                <a href="<?php echo base_url().'Tour/EditData/'.$a->id_tour;?>"><button type="button" class="btn btn-warning">Edit</button> </a>
                                                <a href="<?php echo base_url().'Tour/hapusData/'.$a->id_tour;?>"><button type="button" class="btn btn-danger">Hapus</button> </a>
