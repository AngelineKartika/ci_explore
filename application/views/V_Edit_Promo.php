                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?=base_url()?>/asset/images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?=base_url()?>/asset/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?=base_url()?>/asset/images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?=base_url()?>/asset/images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?=base_url()?>/asset/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Edit Data Promo</strong>

                                  </div>
                                  <?php foreach ($promo as $listPromoEdit)?>

                                  <form action="<?php echo base_url().'Promo/UpdateData';?>" method="post">
                                  <div class="card-body card-block">
                                      <div class="form-group">
                                          <label for="company" class=" form-control-label">ID Promo</label>
                                          <input type="text" id="company" class="form-control" name="id" value="<?=$listPromoEdit->id_promo?>" readonly>
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Nama promo</label>
                                          <input type="text" id="vat" class="form-control" name="nama" value="<?=$listPromoEdit->nama_promo?>">
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Diskon</label>
                                          <input type="text" id="vat" class="form-control" name="nama" value="<?=$listPromoEdit->diskon_promo?>">
                                      </div>
