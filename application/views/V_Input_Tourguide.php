                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Tambah Data Tourguide</strong>

                                  </div>
                                  <form action="<?php echo base_url().'Tourguide/insertData';?>" method="post">
                                  <div class="card-body card-block">
                                      <div class="form-group">
                                          <label for="company" class=" form-control-label">ID Pengguna</label>
                                          <input type="text" id="company" class="form-control" name="id_pengguna">
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">ID Tourguide</label>
                                          <input type="text" id="vat" class="form-control" name="id">
                                      </div>
