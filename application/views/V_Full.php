...
<html lang="en">
  ...
  <body>
  <section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb" id="about-section" style="margin-top:100px" >
    			...
    			<div class="col-md-6 col-lg-7 px-lg-5 py-md-5 bg-darken">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-5 p-lg-0">
			          	<span class="subheading">Sorry this tour is full :(</span>
			            <h2 class="mb-4">Don't Worry We Have Other Destination</h2>


			            <p><a href="<?=base_url()?>/#destination-section" class="btn btn-primary py-3 px-4">Search</a></p>
			          </div>
			        </div>
		        </div>
	        </div>
