                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Tambah Data Promo</strong>

                                  </div>
                                  <form action="<?php echo base_url().'Promo/insertData';?>" method="post">
                                  <div class="card-body card-block">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label">ID</label>
                                        <?php
                                        $queryp=mysqli_query($koneksi,"SELECT *FROM promo");
                                        $baris=mysqli_num_rows($queryp);
                                        $barisbaru=$baris+1;
                                        ?>
                                        <input type="text" id="company" class="form-control" name="id" value="<?php echo "PRM-".$barisbaru?>" readonly>
                                    </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Nama Promo</label>
                                          <input type="text" id="vat" class="form-control" name="nama">
                                      </div>
                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Diskon Promo</label>
                                          <input type="text" id="vat" class="form-control" name="diskon">
                                      </div>
