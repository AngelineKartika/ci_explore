                            ...
                            <div class="col-lg-9">
                              <div class="card">
                                  <div class="card-header">
                                      <strong>Tambah Data Tour</strong>

                                  </div>
                                  <form action="<?php echo base_url().'Tour/insertData';?>" method="post">
                                  <div class="card-body card-block">
                                    <div class="form-group">
                                        <label for="company" class=" form-control-label">ID</label>
                                        <?php
                                        $queryp=mysqli_query($koneksi,"SELECT *FROM tour");
                                        $baris=mysqli_num_rows($queryp);
                                        $barisbaru=$baris+1;
                                        ?>
                                        <input type="text" id="company" class="form-control" name="id" value="<?php echo "T-".$barisbaru?>" readonly>
                                    </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="date" name="tanggal" id="date1" alt="date" class="IP_calendar" title="d/m/Y">
                                      </div>

                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Hari </label>
                                          <input type="int" id="vat" class="form-control" name="hari">
                                      </div>

                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Harga </label>
                                          <input type="int" id="vat" class="form-control" name="harga">
                                      </div>

                                      <div class="form-group">
                                          <label for="vat" class=" form-control-label">Kuota </label>
                                          <input type="int" id="vat" class="form-control" name="kuota">
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <select name = "id_promo" class="form-control">
                                              ...
                                              <option value = "<?php echo $p->id_promo ?>">
